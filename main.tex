...
\definecolor{primary_color}{RGB}{200, 60, 60}    % 松针红
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north, inner sep=0pt](header) at (current page.north){
            \includegraphics[width=\paperwidth]{images/header-red.png}
        };
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.2\textwidth]{images/banner_GDUT.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south, inner sep=0pt](footer) at (current page.south){
            \includegraphics[width=\paperwidth]{images/footer-red.png}
        };
        % 联系方式
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/image_GDUT.png}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{工业大学}}，专科 \hfill 2000年9月--2010年6月
        \begin{itemize}
            \item 你的学院，你的专业
        ...
        \vspace{0.5em}
        {\large \textbf{工业大学}}，本科 \hfill 2010年9月--2020年6月
        \begin{itemize}
            \item 你的学院，你的专业
            \item \textbf{主修课程}：课程1、课程2、课程3、课程4\ 等。
        ...
        \vspace{0.5em}
        {\large \textbf{工业大学}}，硕士 \hfill 2020年9月--至今
        \begin{itemize}
